// Per-city placeholder page. Handles 'open' and 'soon' status with different copy.
function ComingSoon({ city, state, status, dateLabel, address, courts, sqft, members, hours, description, accent = 'green' }) {
  ...
  return (
    <>
      <section style={{
        background: 'var(--navy)',
        color: 'var(--off-white)',
        padding: 'clamp(96px, 13vw, 180px) 0 clamp(56px, 7vw, 96px)',
        position: 'relative',
        overflow: 'hidden',
      }}>
        ...
        <div className="container" style={{ position: 'relative' }}>
          ...
          <h1 className="h-display" style={{
            ...
            PikLab {city}<span style={{ color: accentColor, fontStyle: 'italic', fontWeight: 500 }}>.</span>
          </h1>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={k} style={{ background: 'var(--navy)', padding: '20px 22px' }}>
                <div className="mono" style={{ color: accentColor, fontSize: '0.66rem', letterSpacing: '0.14em' }}>{k.toUpperCase()}</div>
                <div style={{
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 40, flexWrap: 'wrap' }}>
            {isOpen ? (
              <>
                ...
                <a href="mailto:info@piklab.ai" className="btn btn-ghost-light">
                  Contact us
                </a>
              </>
            ) : (
              <>
                <a href="concord.html" className="btn btn-green">
                  See the Concord pilot
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </a>
                <a href="locations.html" className="btn btn-ghost-light">
                  All locations
                </a>
              </>
            )}
